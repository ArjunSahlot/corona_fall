...
print("Installing...")
try:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/corona_fall/archive/main.zip", tmp)
    file += "main"
except urllib.error.HTTPError:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/corona_fall/archive/master.zip", tmp)
    file += "master"
